...
int ll_sort(LinkedList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL && (order == 0 || order == 1))
    {
        ...
        for( int i = 0; i < len -1; i++)
        {
            ...
            {
                comparacion = pFunc(ll_get(this, i), ll_get(this, j));// 1: A > B estan desordenados
...
*/
/** \brief Mapea los elementos de la lista asignando valores a sus campos por una función criteio
 *
